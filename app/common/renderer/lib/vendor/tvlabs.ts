...
export class TvlabsVendor extends BaseVendor {
  override async configureProperties(): Promise<void> {
    ...
    const apiKey = (tvlabs.apiKey as string | undefined) || (process.env.TVLABS_API_KEY as string | undefined);
    ...
    const host = process.env.TVLABS_WEBDRIVER_URL || (tvlabs.host as string | undefined) || 'appium.tvlabs.ai';
