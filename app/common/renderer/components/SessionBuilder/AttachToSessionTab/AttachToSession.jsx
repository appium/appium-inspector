 ...
 */
const AttachToSession = ({serverType, runningAppiumSessions, gettingSessions, getRunningSessions, loadNewSession}) => {
  const {t} = useTranslation();

  return (
    <Space className={styles.spaceContainer} orientation="vertical" size="large">
      <AttachToSessionInstructions />
      <ManualIdInputAndRefreshBtn loadNewSession={loadNewSession} getRunningSessions={getRunningSessions} />
