...
different fields - for example, TestMu AI (Formerly LambdaTest) only requires the _username_ and _access key_:

![TestMu AI (Formerly LambdaTest) Server Details](./assets/images/server-details/testmuai-details.png)
