...
const ROOT_PKG_JSON_PATH = path.join(path.dirname(fileURLToPath(import.meta.url)), '..', 'package.json');
const PLUGIN_PKG_JSON_PATH = path.join(path.dirname(fileURLToPath(import.meta.url)), '..', 'plugins', 'package.json');
